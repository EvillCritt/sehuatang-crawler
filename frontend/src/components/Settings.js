  ...
  return (
    <div style={{ padding: '16px', maxWidth: '100%' }}>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      ...
                      { 
                        ...
                        message: '代理格式：http://host:port 或 http://username:password@host:port 或 socks5://host:port' 
                      }
                    ]}
                  >
                    <Input
                      placeholder="代理地址，如：http://127.0.0.1:7890 或 http://user:pass@127.0.0.1:7890"
      ...
      <Modal
        ...
        style={{ top: window.innerWidth <= 768 ? 20 : 100 }}
      >
        <Form
          form={taskForm}
          layout="vertical"
